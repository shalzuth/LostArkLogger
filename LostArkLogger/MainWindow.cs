...
namespace LostArkLogger
{
    public partial class MainWindow : Form
    {
        ...
        void ProcessPacket(List<Byte> data)
        {
            ...
            if (BitConverter.ToUInt16(data.ToArray(), 2) == OpCodes.PKTCombatStatusNotify) combatFound = true;
